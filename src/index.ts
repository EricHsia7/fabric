...
import { handleTouchStart_eraser, handleTouchMove_eraser, handleTouchEnd_eraser } from './graph/eraser.ts';
import { handleTouchStart_pen, handleTouchMove_pen, handleTouchEnd_pen } from './graph/pen.ts';
import { handleTouchStart_mover, handleTouchMove_mover, handleTouchEnd_mover } from './graph/mover.ts';
